...
class CodaPrompt(nn.Module):
    ...
    def forward(self, x_querry, l, x_block, train=False, task_id=None, ortho_n_fix=False, maml=False, memQ=None):
        ...
        if l in self.e_layers:
            ...
            A = getattr(self,f'e_a_{l}')
            p = getattr(self,f'e_p_{l}')
            pt = int(self.e_pool_size / (self.n_tasks)) # avg of num of prompts for each task
            s = int(self.task_count * pt)
            f = int((self.task_count + 1) * pt) 
